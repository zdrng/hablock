...
interface GateEngine {
    ...
    suspend fun onScheduleTransition()
    suspend fun onDayReset()
    suspend fun onDayBoundaryChanged()
    suspend fun markEmergencyUnlockUsed(blockId: String)
...
interface AlarmScheduler {
    ...
    fun scheduleScheduleTransition(at: Instant)
    fun cancelScheduleTransition()
